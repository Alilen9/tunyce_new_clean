...
export const LoadingSkeleton = () => {
    return(
        <div role="status" className="w-44 border-gray-300 m-2  min-w-[180px] xl:min-w-[100px] md:min-w-[190px] border p-3 md:p-2 rounded  animate-pulse ">
            ...
            <div className="h-3 bg-gray-200 dark:bg-gray-400 w-24 mb-2.5"></div>
            <div className="h-2 bg-gray-200 dark:bg-gray-400 w-20 mb-4"></div>
        </div>
    )
}
